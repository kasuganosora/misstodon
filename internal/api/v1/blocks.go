...
func BlocksRouter(r *gin.RouterGroup) {
	r.GET("/blocks", BlocksListHandler)
}

func BlocksListHandler(c *gin.Context) {
	...
	accounts, err := misskey.BlocksList(ctx, query.Limit, query.SinceID, query.MaxID)
	if err != nil {
